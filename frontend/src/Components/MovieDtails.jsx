...
function MovieDetails() {
  ...
  const handleUserRatingChange = async (newRating) => {
    try {
      ...
      const response = await axios.put(`http://localhost:4000/api/movies/${id}/rate`, { rating: newRating });
      setUserRating(response.data.userRating);
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6" style={{ color: "white" }}>
              ...
              <p><strong>Average Rating:</strong> {averageRating}</p> {/* Display the average rating */}
              <Rating
